        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="http://localhost/mayuri/admin/dashboard.php">
                        <!-- Logo icon -->
                         <?php
             ...
             ?>
                        <b><img src="../assets/myimages/white.svg" alt="homepage" class="dark-logo" style="width:100px;"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
